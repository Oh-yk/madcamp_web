...
const symtoms = [
    {
        ...
        aid : "그늘지고 시원한 곳에서 충분히 휴식을 취한다. 차가운 이온음료나 연한 소금물로 전해질을 보충한다. 물을 뿌려주거나 부채질을 해주면 좋다. 30분안에 증상이 호전되지 않으면 병원을 방문한다.",
    ...
    },
    {
        ...
        aid : "즉시 119에 전화한 후, 시원한 곳으로 옮긴다. 물에 적신 수건 등으로 체온을 내린다. 겨드랑이에 얼음을 대면 심부온도를 빠르게 낮출 수 있다.",
    ...
    },
    {
        index : 4,
        name : "장경인대 증후군",
        picture : "https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Ft1.daumcdn.net%2Fcfile%2Ftistory%2F99716E415AF3C8FF35",
        aid : "자전거 운행을 멈추고, 얼음찜질을 해주며, 운동 전후로 스트레칭을 한다.",
        symtom : "무릎 바깥쪽에 타는듯한 통증이 발생한다. 누르면 심한 통증이 느껴지고, 주변으로 통증이 퍼지기도 한다."
    }
]
